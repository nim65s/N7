...
[N1, Wn1] = buttord([2*300/Fe 2*400/Fe], [2*200/Fe 2*500/Fe], 3, 30);
[N2, Wn2] = buttord([2*1000/Fe 2*1300/Fe], [2*800/Fe 2*1500/Fe], 3, 30);
[B1, A1] = butter(N1, Wn1);
[B2, A2] = butter(N2, Wn2);
