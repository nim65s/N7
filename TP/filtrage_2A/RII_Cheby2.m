...
[N1, Wn1] = cheb2ord([2*300/Fe 2*400/Fe], [2*200/Fe 2*500/Fe], 3, 30);
[N2, Wn2] = cheb2ord([2*1000/Fe 2*1300/Fe], [2*800/Fe 2*1500/Fe], 3, 30);
[B1, A1] = cheby2(N1+2, 40, Wn1);   %on augmente l'ordre pour répondre au cahier des charges
[B2, A2] = cheby2(N2+2, 40, Wn2);
