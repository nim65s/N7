...
[N1, Wn1] = cheb1ord([2*300/Fe 2*400/Fe], [2*200/Fe 2*500/Fe], 3, 30);
[N2, Wn2] = cheb1ord([2*1000/Fe 2*1300/Fe], [2*800/Fe 2*1500/Fe], 3, 30);
[B1, A1] = cheby1(N1, 3, Wn1);
[B2, A2] = cheby1(N2, 3, Wn2);
