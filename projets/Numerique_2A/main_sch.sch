...
<drawing version="7">
    ...
    <netlist>
        ...
        <block symbolname="compteur_etalonnage" name="XLXI_10">
            <blockpin signalname="entree" name="entree" />
            <blockpin signalname="clk" name="clk" />
            <blockpin signalname="rst" name="rst" />
            <blockpin name="depassement_sup" />
            <blockpin name="depassement_inf" />
            <blockpin name="nombre(13:0)" />
        </block>
        <block symbolname="compteur_echantillonage" name="XLXI_11">
            <blockpin signalname="entree" name="entree" />
            <blockpin signalname="clk" name="clk" />
            <blockpin signalname="rst" name="rst" />
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <instance x="560" y="1888" name="XLXI_10" orien="R0">
        </instance>
        <instance x="560" y="1504" name="XLXI_11" orien="R0">
        </instance>
    </sheet>
</drawing>